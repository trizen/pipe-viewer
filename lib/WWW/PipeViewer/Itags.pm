...
sub get_itags {
    scalar {
        ...
        '2160' => [{value => 315, format => 'webm', split => 1, hfr => 1},    # webm HFR (v)
                   ...
                   {value => 337, format => 'webm', split => 1, hdr => 1},    # vp9 HDR (v)
                   {value => 701, format => 'mp4',  split => 1, hdr => 1},    # mp4 HDR (v)
                  ],
        ...
        '1440' => [{value => 308, format => 'webm', split => 1, hfr => 1},    # webm HFR (v)
                   ...
                   {value => 336, format => 'webm', split => 1, hdr => 1},    # vp9 HDR (v)
                   {value => 700, format => 'mp4',  split => 1, hdr => 1},    # mp4 HDR (v)
                  ],
